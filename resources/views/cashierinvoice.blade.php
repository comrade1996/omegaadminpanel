...
<head>
    ...
    <link rel="stylesheet" href="/css/cashierinvoice.css">
</head>
<body>
<?php
...
<div id="app">
    ...
    <article>
        ...
        <table class="margin padding" style="text-align: center">
            <tr>
        ...
        <table class="margin">
            ...
            @for($i=0;$i<count($sells);$i++)
                <tr>
                    ...
                    <td style="text-align: center"><span>{{$sells[$i]->quantity}}</span></td>
